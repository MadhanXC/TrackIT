          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3 px-2 py-2">
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-[11px] font-bold text-slate-950 truncate uppercase tracking-tight">
                  {user?.displayName || 'Authorized User'}
                </span>
                <span className="text-[9px] text-slate-400 truncate lowercase font-medium leading-none">
                  {user?.email}
                </span>
              </div>
            </div>
